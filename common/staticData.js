...
import icon_wallet from "Images/footer/wallet.png";
import icon_wallet_a from "Images/footer/wallet_active.png";
...
export const askedData = {
  ...
  chong_ti: [
    ...
    },
    {
      ...
      content: [
        ...
        "4、钱包提币前需确保所提供提币地址准确无误，若无地址可选择新建地址，提币手续费每笔为提币USDT数量的2%。",
        "5、所有充提币记录可在历史明细查看。"
      ],
      name: 7
    }
  ...
  other_list: [
    ...
    },
    {
      title: "推广下线是如何分成的？",
      content: [
        "本平台采用师徒制的推广方式，您将获取您一级下线交易手续费的15%。"
      ],
      name: 19
    },
    {
